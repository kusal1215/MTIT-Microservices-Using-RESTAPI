package com.sliit.mtit.microservice.adminservice.config;
...
public class SwaggerConfig {
    ...
    private ApiInfo metaData() {
        return new ApiInfoBuilder()
                .title("Admin Service - Spring Boot Swagger Configuration")
                .description("\"Swagger configuration for Admin Service \"")
                .version("1.1.0")
                .license("Apache 2.0")
