package com.sliit.mtit.microservice.productreturnservice.config;
...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("Product Return Service - Spring Boot Swagger Configuration")
