package com.sliit.mtit.microservice.shoppingcartservice.config;
...
public class SwaggerConfig {
    ...
    private ApiInfo metaData() {
        return new ApiInfoBuilder()
                .title("Shopping cart Service - Spring Boot Swagger Configuration")
                .description("\"Swagger configuration for Shopping cart Service \"")
                .version("1.1.0")
                .license("Apache 2.0")
