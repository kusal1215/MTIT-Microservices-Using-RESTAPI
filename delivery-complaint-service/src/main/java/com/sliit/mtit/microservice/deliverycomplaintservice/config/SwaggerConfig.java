package com.sliit.mtit.microservice.deliverycomplaintservice.config;
...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("Delivery Complaint Service - Spring Boot Swagger Configuration")
