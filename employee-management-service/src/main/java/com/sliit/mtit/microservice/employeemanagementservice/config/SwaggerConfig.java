package com.sliit.mtit.microservice.employeemanagementservice.config;
...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("Employee Service - Spring Boot Swagger Configuration")
